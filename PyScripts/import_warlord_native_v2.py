"""THE RUST WARLORD enters the engine â€” mesh + 9 clips + material, one session.
...
DEST = "/Game/Art/WarlordSkelV2"   # V2: July 23 reinstall — V1 clips had dead COMPRESSED streams (raw curves alive, runtime frozen)
NAME = "SCB2Warlord"
...
if EAL.does_directory_exist(DEST):
    ...
    if not ok:
        raise SystemExit("WAR_WIPE_FAILED (CDO lock?) â€” bump folder version")
