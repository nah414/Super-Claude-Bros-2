...
Every connect_material_property result is checked — silent unconnected pins gave
...
# coat=1.0 / coat-roughness=0.1 — setting the shading model alone is the wet look.
...
# save_loaded_asset IMMEDIATELY after recompile — the fix_materials.py pattern.
